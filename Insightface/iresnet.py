...
def _iresnet(arch, block, layers, model_path, progress, **kwargs):
...
def iresnet100(model_path, progress=True, **kwargs):
    return _iresnet('iresnet100', IBasicBlock, [3, 13, 30, 3], model_path, progress,
                    **kwargs)